...
UPDATE_HOUR = 0  # 0 = midnight UTC (change if you want a different daily update time)
...
# --- Main loop ---
print("Monthly leaderboard updater started")
...
while True:
    ...
    print(f"Next leaderboard update in {int(sleep_seconds // 3600)}h {int((sleep_seconds % 3600)//60)}m")
    ...
    try:
        ...
        time.sleep(60)  # wait a minute before retrying if it fails