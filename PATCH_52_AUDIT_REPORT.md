# PATCH 52 AUDIT REPORT

## Actual code changes

- Added `tools/generate_data_schema_docs.py`
- Generated `MMO_STATE_SCHEMA_GENERATED.md`
- Generated `RESOURCE_FLOW_GENERATED.md`

## Why this patch matters

Patch 50 made command docs reproducible.
Patch 51 made architecture auditing reproducible.
Patch 52 makes MMO-state schema and resource-flow docs reproducible from the source code.

Run:

```bash
python tools/generate_data_schema_docs.py
```

## Generator output

```text
Detected 31 profile keys and 16 state keys.
